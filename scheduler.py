...
Поверх всех трёх — анти-старвейшн ``max_wait_secs``: задачу, которую забыли,
обслуживаем вне очереди и вне круга.
...
def pick_job(pending, video_types, policy, *, max_video_batch, max_wait_secs,
    ...
    # Он выше и круга по людям, и батчинга — забытая задача важнее и того,
    # и другого.
